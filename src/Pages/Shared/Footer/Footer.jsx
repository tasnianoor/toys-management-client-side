...
//                 <a  href='/' target='_blank' className="link link-hover">Facebook</a>
//                 <a  href='/' target='_blank' className="link link-hover">Twitter</a>
//                 <a  href='/' target='_blank' className="link link-hover">Linkdin</a>
//                 <a  href='/' target='_blank' className="link link-hover">Github</a>
//             </div>
//             <div>
...
//             <div>
//             <span className="footer-title">DISNEY STORE</span>
//   <p className="font-semibold text-base text-gray-500 dark:text-gray-300">
//              © 2023  Disney Store
//      </p>
//   <p className="text-sm md:text-base lg:text-lg text-gray-500 dark:text-gray-400 font-medium mt-2 w-[320px] md:w-[391px]">
//               Send us Email
//             </p>
...
// import React from 'react';
import logo from '../../../assets/icon/logof4.png'
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center items-center  text-white sm:justify-start">
                            ...
                            <h2 className='text-xl font-bold tracking-wide ml-3  text-white  hover:text-amber-400 hover:cursor-pointer'>Disney Store</h2>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1  text-white">disney@store.com</span>
                                    </a>
                                </li>
